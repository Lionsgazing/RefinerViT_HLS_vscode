...
def GetReports():
    Mreports: list[HLSReport] = []

    Mreports.append(HLSReport(
    ...
    Nreports: list[HLSReport] = []

    Nreports.append(HLSReport(
        reportName="Optimization 0",
        latency_ns=164000,
        bram=0,
        dsp=64,
    ...
    Preports: list[HLSReport] = []

    Preports.append(HLSReport(
        reportName="Optimization 0",
        latency_ns=20530,
        bram=0,
        dsp=128,
    ...
    return Mreports, Nreports, Preports